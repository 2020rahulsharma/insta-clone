...
#### When a user follow someone this method is called####
####m2m_changed. Sent when a ManyToManyField is changed on a model instance.###
@receiver(m2m_changed, sender=Profile.following.through)
def add_follower(sender, instance,  action, pk_set, reverse, **kwargs):
    followed_users = []
    logged = User.objects.get(userprofile=instance)
    print(logged,'add follower is called')
